...
if __name__ == '__main__':
	...
	Base_path = '/Data/Base_Data/Climate/AK_CAN_2km_v2'
	...
	CRU_path = '/Data/Base_Data/Climate/AK_CAN_2km_v2/CRU_TS323/historical'

	dic = defaultdict( lambda: defaultdict( lambda: defaultdict ) )

	for i in itertools.product([Base_path] , models , scenarios , variables) :
	...
	pickle.dump( dic2, open( "/workspace/Shared/Users/jschroder/TMP/Climate_full_V2.p", "wb" ) )
